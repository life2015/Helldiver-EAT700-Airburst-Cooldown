"""Deploy/remove only journaled EAT-700 airburst addon files while Helldivers 2 is closed."""
...
def main():
    ...
    if args.action=='uninstall':
        ...
        record['status']='removed';JOURNAL.write_text(json.dumps(record,indent=2));print('Removed recorded EAT-700 airburst addon files');return
    if JOURNAL.exists():
