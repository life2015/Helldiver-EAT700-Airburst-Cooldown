...
io.open=function(path,mode)if path:match('EATAirburst.log$')then return nil end;return old_io_open(path,mode)end
...
EATAirburst=nil;update=real_update
...
profile.dll_sha256='dll';EATAirburst=nil
